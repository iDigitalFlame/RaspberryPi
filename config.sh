...
mkdir -p "${SETUP_DIRECTORY}/etc/systemd/system/systemd-resolved.service.d" 2> /dev/null
...
/usr/bin/printf '= mkinitcpio-busybox\nOperation   = Remove\nOperation   = Install\nOperation   =' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/00-boot.hook"
/usr/bin/printf ' Upgrade\n\n[Action]\nWhen        = PreTransaction\nExec        = /usr/bin/mount' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/00-boot.hook"
/usr/bin/printf ' -o remount,rw /boot\nDescription = Mounting /boot as read/write..\n' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/00-boot.hook"
...
/usr/bin/printf '\nType        = Package\nTarget      = linux\nTarget      = linux-*\nTarget     ' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/zz-boot.hook"
/usr/bin/printf ' = systemd\nTarget      = mkinitcpio\nTarget      = mkinitcpio-git\nTarget      ' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/zz-boot.hook"
/usr/bin/printf '= mkinitcpio-busybox\nOperation   = Remove\nOperation   = Install\nOperation   =' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/zz-boot.hook"
/usr/bin/printf ' Upgrade\n\n[Action]\nWhen        = PostTransaction\nExec        = /usr/bin/moun' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/zz-boot.hook"
/usr/bin/printf 't -ro remount,ro /boot\nDescription = Mounting /boot as read only..\n' >> "${SETUP_DIRECTORY}/etc/pacman.d/hooks/zz-boot.hook"
...
/usr/bin/printf 'export PYTHONPYCACHEPREFIX="/var/cache/python"\n' >> "${SETUP_DIRECTORY}/etc/profile.d/history.sh"
...
/usr/bin/printf '         0.0.0.0\nKexAlgorithms                   curve25519-sha256@libssh.org,d' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'iffie-hellman-group-exchange-sha256\nLoginGraceTime                  1m\nPermitR' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'ootLogin                 yes\nAllowTcpForwarding              no\nAuthorizedKeys' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'File              .ssh/authorized_keys\nClientAliveCountMax             0\nClien' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'tAliveInterval             600\nIgnoreUserKnownHosts            no\nPermitEmptyP' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'asswords            no\nAllowAgentForwarding            no\nPubkeyAuthentication' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf '            yes\nAuthenticationMethods           publickey password\nPasswordAut' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'hentication          yes\nKerberosAuthentication          no\nHostbasedAuthentic' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
/usr/bin/printf 'ation         no\nChallengeResponseAuthentication no\n' >> "${SETUP_DIRECTORY}/etc/ssh/sshd_config"
...
# Create file "/etc/systemd/system/systemd-resolved.service.d/override.conf"
/usr/bin/printf "" > "${SETUP_DIRECTORY}/etc/systemd/system/systemd-resolved.service.d/override.conf"
/usr/bin/printf '[Unit]\nAfter    = var.mount\nRequires = var.mount\n' >> "${SETUP_DIRECTORY}/etc/systemd/system/systemd-resolved.service.d/override.conf"
...
/usr/bin/printf 'baseOptional\nCleanMethod         = KeepInstalled\nArchitecture        = aarch64' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '\nParallelDownloads   = 5\nLocalFileSigLevel   = Optional\n\nNoExtract          ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf ' = usr/share/locale/* usr/share/X11/locale/*/* usr/share/i18n/locales/* opt/goog' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'le/chrome/locales/* !usr/share/X11/locale/C/*\nNoExtract           = !usr/share/' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'X11/locale/compose.dir !usr/share/X11/locale/iso8859-1/*\nNoExtract           = ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '!*locale*/en*/* !usr/share/*locale*/locale.*\nNoExtract           = !usr/share/*' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'locales/en_?? !usr/share/*locales/i18n* !usr/share/*locales/iso*\nNoExtract     ' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '      = usr/share/i18n/charmaps/* !usr/share/i18n/charmaps/UTF-8.gz !usr/share/i' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '18n/charmaps/ANSI_X3.4-1968.gz !usr/share/i18n/charmaps/ISO-8859-1.gz\nNoExtract' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf '           = !usr/share/*locales/trans*\nNoExtract           = !usr/share/*local' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'es/C !usr/share/*locales/POSIX\nNoExtract           = usr/share/vim/vim*/lang/*\n' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'NoExtract           = usr/share/gtk-doc/html/*\nNoExtract           = usr/share/' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'doc/HTML/*\nNoExtract           = usr/share/help/* !usr/share/help/C/*\n\nVerbos' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
/usr/bin/printf 'ePkgLists\n\n[aur]\nInclude             = /etc/pacman.d/mirrorlist\n[core]\nIncl' >> "${SETUP_DIRECTORY}/etc/pacman.conf"
